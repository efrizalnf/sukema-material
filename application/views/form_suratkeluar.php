                        ...
                        <div class="panel panel-default padding-md mt-4">
                            <ul class="nav nav-tabs justify-content-center" role="tablist">
                                <li class="w-50 text-center">
                                    <a class="nav-link active font-weight-bold" data-toggle="tab" href="#rekap_suratkeluar"
                                        role="tab">Rekap
                                        Surat Keluar</a>
                                </li>
                                <li class="w-50 text-center">
                                    <a class="nav-link m-auto font-weight-bold" data-toggle="tab" href="#template_suratkeluar">Pilih
                                        Template
                                        Surat</a>
                                </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body">
                                                    <a type="button" class="btn btn-success rounded"
                                                        href="<?= base_url('sukema/templatesurat')?>">Pilih Template</a>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-4">
