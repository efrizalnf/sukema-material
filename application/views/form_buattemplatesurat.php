                            ...
                            <div class="card-body">
                                <div class="row justify-content-md-center">
                                    <div class="col-lg-2 m-3">
                                        <img src="<?=base_url()?>assets/images/logo-enha.png" width="150" height="150"
                                            alt="logo">
                                    </div>
                                    <div class="col-md-auto text-center m-auto" style="line-height:8px;">
                                        <p style="font-size:26px;">YAYASAN PENDIDIKAN ISLAM NURUL HUDA (YAPINDA)</p>
                                        <p style="font-size:34px; font-weight:bold; margin-top:30px;">MADRASAH ALIYAH
                                            NURUL HUDA
                                        </p>
                                        <p style="font-size:30px; font-weight:bold; margin-top:32px;">"TERAKREDITASI A"
                                        </p>
                                ...
                                <div class="row linebar">
                                    <div class="line m-auto bg-success text-white rounded text-center">
                                        <p class="address m-auto p-2 text-uppercase font-weight-bold"
                                            style="font-size:12px;"> Alamat : Jl.KH.Wahid Hasyim Gg.Parasdi Dalam I No.
